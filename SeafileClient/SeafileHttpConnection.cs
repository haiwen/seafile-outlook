...
{
    public class SeafileHttpConnection : ISeafileWebConnection
    {
        /// <summary>
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        public async Task<T> SendRequestAsync<T>(Uri serverUri, SeafRequest<T> request, CancellationToken token)
        {            
