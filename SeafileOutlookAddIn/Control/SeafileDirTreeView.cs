...
namespace SeafileOutlookAddIn.Control
{
    public partial class SeafileDirTreeView : TreeView
    {
        ...
        private string libraryidPropertyName;
        private string parentIdPropertyName;
        private string dirtypePropertyName;
        ...
        private PropertyDescriptor libraryidProperty;
        private PropertyDescriptor dirtypeProperty;
        ...
        /// Default constructor.
        /// </summary>
        public SeafileDirTreeView()
        {
            this.idPropertyName = string.Empty;
            this.namePropertyName = string.Empty;
            this.dirtypePropertyName = string.Empty;
            this.libraryidPropertyName = string.Empty;
            this.pathPropertyName = string.Empty;
        ...
        Editor(typeof(FieldTypeEditor), typeof(UITypeEditor)),
        Category("Data"),
        Description("DirType member. Note: editing of this column available only with types that support converting from string.")
        ]
        public string DirTypeColumn
        {
            get
            {
                return this.dirtypePropertyName;
            }
            set
            {
                if (this.dirtypePropertyName != value)
                {
                    this.dirtypePropertyName = value;
                    this.dirtypeProperty = null;
                    this.ResetData();
                }
            }
        }
        ...
        Editor(typeof(FieldTypeEditor), typeof(UITypeEditor)),
        Category("Data"),
        Description("Path member. Note: editing of this column available only with types that support converting from string.")
        ]
        public string PathColumn
        {
            ...
            set
            {
                if (this.pathPropertyName != value)
                {
                    this.pathPropertyName = value;
        ...
        Editor(typeof(FieldTypeEditor), typeof(UITypeEditor)),
        Category("Data"),
        Description("LiberID member. Note: editing of this column available only with types that support converting from string.")
        ]
        public string LibraryIDColumn
        {
            get
            {
                return this.libraryidPropertyName;
            }
            set
            {
                if (this.libraryidPropertyName != value)
                {
                    this.libraryidPropertyName = value;
                    this.libraryidProperty = null;
                    this.ResetData();
                }
            }
        }
        ...
        private bool PrepareDescriptors()
        {
                ...
                && this.parentIdPropertyName.Length != 0)
            {
                ...
                if (this.dirtypeProperty == null)
                {
                    this.dirtypeProperty = this.listManager.GetItemProperties()[this.dirtypePropertyName];
                }
                if (this.pathProperty == null)
                {
                    this.pathProperty = this.listManager.GetItemProperties()[this.pathPropertyName];
                }
                if (this.libraryidProperty == null)
                {
                    this.libraryidProperty = this.listManager.GetItemProperties()[this.libraryidPropertyName];
                }
