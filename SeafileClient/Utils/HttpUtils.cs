...
namespace SeafileClient.Utils
{
    ...
    static class HttpUtils
    {
        ...
        /// <param name="getParams">Post parameters</param>
        /// <returns>The http response</returns>        
        public static HttpRequestMessage CreatePutRequest(Uri uri, IEnumerable<KeyValuePair<string, string>> headerInfo, IEnumerable<KeyValuePair<string, string>> postParams)
        {
